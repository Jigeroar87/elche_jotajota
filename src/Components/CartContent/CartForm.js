            ...
            <div className="row">
                <div className="container-fluid  pt-5">
                    <div className="col-8 offset-2 col-md-6 offset-md-3">
                            <form>
                                <h1>Para finalizar compra, coloca tus datos:</h1>
                                ...
                                <div className="mb-3">
                                    <label for="fapellido" className="form-label">Apellido:</label>
                                    <input type="text" id="fapellido" className="form-control" required placeholder="Apellido"/>
                                </div>
